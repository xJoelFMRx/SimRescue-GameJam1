...
void panelControl(int habitantesRestantes, Vehiculo* helicop, Rescate* rescate, int x, int y) {
    ...
    cursor(x, y + 2);
    cout << "TAMANO: " << xtamaño[0] << "x" << ytamaño[0];
    cursor(x, y + 3);
    ...
    cursor(x + 35, y + 2);
    cout << "TAMANO: " << xtamaño[1] << "x" << ytamaño[1];
    cursor(x + 35, y + 3);
    ...
    cursor(x + 70, y + 2);
    cout << "TAMANO: " << xtamaño[2] << "x" << ytamaño[2];
    cursor(x + 70, y + 3);
...
void introduccion() {
    ...
    int diseño;
    color = aleatorio(2, 16);
    diseño = aleatorio(1, 8);
    dibujarHelicopter(69, 0, color, diseño, 1);

    _sleep(500);
    color = aleatorio(2, 16);
    diseño = aleatorio(1, 8);
    dibujarHelicopter(69, 10, color, diseño, 1);

    _sleep(500);
    color = aleatorio(2, 16);
    diseño = aleatorio(1, 8);
    dibujarHelicopter(69, 20, color, diseño, 1);

    _sleep(500);
    color = aleatorio(2, 16);
    diseño = aleatorio(1, 8);
    dibujarHelicopter(69, 30, color, diseño, 1);


    _sleep(500);
    color = aleatorio(2, 16);
    diseño = aleatorio(1, 8);
    dibujarHelicopter(9, 15, color, diseño, 1);

    _sleep(500);
    color = aleatorio(2, 16);
    diseño = aleatorio(1, 8);
    dibujarHelicopter(39, 15, color, diseño, 1);

    _sleep(500);
    color = aleatorio(2, 16);
    diseño = aleatorio(1, 8);
    dibujarHelicopter(99, 15, color, diseño, 1);

    _sleep(500);
    color = aleatorio(2, 16);
    diseño = aleatorio(1, 8);
    dibujarHelicopter(129, 15, color, diseño, 1);
...
void instrucciones() {
    ...
    cout << endl;
    cout << endl;
    cout << "\t3. ¿Cuando termina la carrera y que pasa luego?:\n";
...
void creditos() {
    ...
    cout << "\t\t______________________________________________________________\n";
    cout << endl;
    cout << "\t© 2024 SimRescue. Todos los derechos reservados.\n";
    cout << "\t\t______________________________________________________________\n";
}
